...
(function (global) {
  ...
  document.addEventListener("DOMContentLoaded", function (event) {
    ...
    //
    // TODO: STEP 1: Replace the URL 'https://coursera-jhu-default-rtdb.firebaseio.com/categories.json'
    // with the URL of your server endpoint that returns the categories data.
  ...
  function buildAndShowHomeHTML(categories) {
    ...
    $ajaxUtils.sendGetRequest(
      ...
      function (homeHtml) {
        ...
        var targetSelector = "#main-content";
        if (document.querySelector(targetSelector) !== null) {
          insertHtml(targetSelector, homeHtmlToInsertIntoMainPage);
        }
      },
      false
    );
